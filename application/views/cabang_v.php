...
?>
	...
	<div class="mainpanel">
		...
		<div class="contentpanel">
			<button class="btn btn-primary tambahdata" data-toggle="modal" data-target="#ModalTambah"><i class="fa fa-plus"></i> Tambah Cabang </button>
			<br><br>
						...
						<table class="table table-striped mb30" id="table-responsive">
							...
							<tbody>
								...
								<tr>
									...
									<td><?PHP $result=mysql_query("SELECT count(*) as data from karyawan WHERE _cabang='".$row->code."'");$data=mysql_fetch_assoc($result);echo $data['data'];?></td>
									<td>
										<a href="<?PHP echo base_url() ?>cabang/edit/<?PHP echo $row->code; ?>" class="fa fa-pencil" style="text-decoration:none;color:green"></a>
									</td>
								</tr>
								<?PHP
										}
...
<form method="post" action="<?PHP echo site_url(); ?>cabang/tambah_data">
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
							...
							<input type="text" autocomplete="off" name="kodecabang" class="form-control" value="<?PHP $result=mysql_query("SELECT count(*) as data from _cabang");$data=mysql_fetch_assoc($result);echo $data['data']+1;?>" readonly />
						</div>
					</div>
					<div class="col-sm-6">
						<div class="form-group">
							<label class="control-label">Nama Cabang <font color="red">*</font></label>
							<input type="text" autocomplete="off" name="nama" class="form-control" required />
						</div>
					</div>
					<div class="col-sm-6">
						<div class="form-group">
							<label class="control-label">Singkatan Cabang <font color="red">*</font></label>
							<input type="text" autocomplete="off" name="singkatan" class="form-control" required />
						</div>
					</div>
				</div>
			</div>
