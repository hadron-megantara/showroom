	...
	<div class="mainpanel">
		...
		<div class="contentpanel">
			<div class="panel panel-default">
				...
				<h4 class="panel-title">Mohon input data user dengan benar</h4>
				</div>
				<form id="basicForm" action="<?PHP echo base_url() ?>user/insert_data" method="post" name="formsentral">
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" autocomplete="off" name="username" class="form-control" maxlength="20" required />
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="password" autocomplete="off" name="password" class="form-control" maxlength="12" required />
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" autocomplete="off" name="telepon" class="form-control" maxlength="20" onkeypress="return isNumberKey(event)" />
							</div>
						</div>
					</div>
					<div class="row">
