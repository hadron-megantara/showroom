	...
	<div class="mainpanel">
		...
		<div class="contentpanel">
			<div class="panel panel-default">
				...
				<h4 class="panel-title">Mohon input data karyawan dengan benar</h4>
				</div>
				<form id="basicForm" action="<?PHP echo base_url() ?>karyawan/insert_data" method="post" name="formsentral">
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" autocomplete="off" name="noktp" class="form-control" required />
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label class="control-label">Jabatan</label>
								<input type="text" autocomplete="off" name="jabatan" class="form-control" />
							</div>
						</div>
					</div>
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<div class="input-group">
									<input type="text" class="form-control" name="mulaikerja" id="datepicker-multiple" readonly required >
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" autocomplete="off" name="tempatlahir" class="form-control" />
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label class="control-label">Tanggal Lahir</label>
									<input type="text" autocomplete="off" name="tgllahir" class="form-control" />
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" autocomplete="off" name="alamatktp" class="form-control" />
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" autocomplete="off" name="gaji" onkeyup="formatAngka(this, ',')" class="form-control" value="0" />
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" autocomplete="off" name="telp" class="form-control" />
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label class="control-label">Uang Makan</label>
								<input type="text" autocomplete="off" name="uangmakan" onkeyup="formatAngka(this, ',')" class="form-control" value="0" />
							</div>
						</div>
					</div>
					<div class="row">
