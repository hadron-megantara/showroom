	...
	<div class="mainpanel">
		...
		<div class="contentpanel">
			<div class="panel panel-default">
				...
				<h4 class="panel-title">Mohon input data peminjaman dengan benar</h4>
				</div>
				...
				<input type="hidden" name="idpeminjaman" value="<?PHP $result=mysql_query("SELECT count(*) as data from detail_peminjaman");$data=mysql_fetch_assoc($result);echo $data['data']+1;?>"/>
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								...
								<select class="form-control mb15" name="karyawan" required >
									...
									?>
									<option value="<?PHP echo $row->idkaryawan; ?>"><?PHP echo $row->nama; ?></option>
									<?PHP
										endforeach;
									?>
								</select>
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" autocomplete="off" name="jumlah" class="form-control" required onkeyup="formatAngka(this, ',');" />
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								...
								<div class="input-group">
									<input type="text" class="form-control" name="jatuhtempo" id="datepicker-multiple" readonly required >
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" autocomplete="off" name="catatan" class="form-control" required />
							</div>
						</div>
					</div>
				</div>
