...
?>
	...
	<div class="mainpanel">
		...
		<div class="pageheader">
			<h2><i class="fa fa-hdd-o"></i> Cancel Penjualan</h2>
		...
		?>
			<div class="panel panel-default">
				<form action="<?PHP echo base_url() ?>batal_penjualan/delete_data" method="post">
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" autocomplete="off" name="iddata" class="form-control" value="<?PHP echo $iddata; ?>" readonly />
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="form-group">
								...
								<input type="text" autocomplete="off" name="ketnya" class="form-control"  required />
							</div>
						</div>
					</div>
				</div>
				<div class="panel-footer">
					<div class="row">
						<div class="col-sm-9">
							<button class="btn btn-danger" value="Batal" name="Batal">Batal</button>
		...
		?>
			<div class="panel panel-default">
				...
				<div class="panel-footer">
					<div class="row">
						<div class="col-sm-9">
							<button type="submit" class="btn btn-danger" value="Batal" name="Batal">Batal</button>
