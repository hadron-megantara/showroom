		...
		<div class="pageheader">
			...
			<div class="breadcrumb-wrapper">
				<ol class="breadcrumb">
					...
					<li class="active">Edit Stok Display</li>
				</ol>
			</div>
		</div>
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" autocomplete="off" name="bcasd" id="bcasd" class="form-control" required onkeyup="formatAngka(this, ',');HitungTotal()" value="<?PHP $result=mysql_query("SELECT hdealer as data from mobil WHERE idmobil='".$iddata."'");$data=mysql_fetch_assoc($result);echo $data['data'];?>" required />
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" autocomplete="off" name="blain" id="blain" class="form-control" required onkeyup="formatAngka(this, ',');HitungTotal()" value="<?PHP $result=mysql_query("SELECT hlain as data from mobil WHERE idmobil='".$iddata."'");$data=mysql_fetch_assoc($result);echo $data['data'];?>" required />
							</div>
						</div>
					</div>
