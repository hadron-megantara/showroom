	...
	<div class="mainpanel">
		...
		<div class="pageheader">
			...
			<div class="breadcrumb-wrapper">
				<ol class="breadcrumb">
					...
					<li><a href="<?PHP echo base_url() ?>rekap_spk">Proses Kredit</a></li>
					<li class="active">Detail Proses Kredit</li>
				</ol>
			</div>
		</div>
		<div class="contentpanel">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
				<form id="basicForm" action="<?PHP echo base_url() ?>rekap_spk/deal_po" method="post" name="formsentral">
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<div class="input-group">
									<input type="text" class="form-control" name="tglpo" id="date1" readonly required value="<?PHP $result=mysql_query("SELECT tglpo as data from penjualan WHERE idpenjualan='".$iddata."'");$data=mysql_fetch_assoc($result);echo $data['data'];?>" >
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" autocomplete="off" name="nominalpo" class="form-control" onkeyup="formatAngka(this, ',')" value="<?PHP $result=mysql_query("SELECT nominalpo as data from penjualan WHERE idpenjualan='".$iddata."'");$data=mysql_fetch_assoc($result);echo number_format($data['data']);?>" />
							</div>
						</div>
					</div>
					<br>
