	...
	<div class="mainpanel">
		...
		<div class="contentpanel">
			<div class="panel panel-default">
				...
				<h4 class="panel-title">Mohon input data supplier dengan benar</h4>
				</div>
				<form id="basicForm" action="<?PHP echo base_url() ?>supplier/insert_data" method="post" name="formsentral">
