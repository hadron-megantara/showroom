...
?>
	...
	<div class="mainpanel">
		...
		<div class="pageheader">
			<h2><i class="fa fa-print"></i> Edit Keterangan Proses</h2>
			<div class="breadcrumb-wrapper">
				<ol class="breadcrumb">
					<li><a href="<?PHP echo base_url() ?>home">Sentral Group</a></li>
					<li><a href="<?PHP echo base_url() ?>home">Home</a></li>
					<li><a href="<?PHP echo base_url() ?>rekapan_proses">Rekapan Proses</a></li>
					<li class="active">Edit Keterangan Proses</li>
				</ol>
			</div>
		</div>
		<div class="contentpanel">
			<div class="panel panel-default">
				...
				<h4 class="panel-title">Mohon edit keterangan proses dengan benar</h4>
				</div>
				<form id="basicForm" action="<?PHP echo base_url() ?>rekapan_proses/edit_data" method="post" name="formsentral">
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" autocomplete="off" name="data" class="form-control" value="<?PHP $result=mysql_query("SELECT ket as data from penjualan WHERE idpenjualan='".$iddata."'");$data=mysql_fetch_assoc($result);echo $data['data'];?>" />
							</div>
						</div>
					</div>
				</div>
