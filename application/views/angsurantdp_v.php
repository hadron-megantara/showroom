...
?>
	...
	<div class="mainpanel">
		...
		<div class="pageheader">
			<h2><i class="fa fa-cog"></i> Angsuran, TDP</h2>
			<div class="breadcrumb-wrapper">
				<ol class="breadcrumb">
					<li><a href="<?PHP echo base_url() ?>home">Sentral Group</a></li>
					<li><a href="<?PHP echo base_url() ?>home">Home</a></li>
					<li class="active">Angsuran, TDP</li>
				</ol>
			</div>
		</div>
				...
				<div class="panel-body">
					...
					<div class="table-responsive">
						<table border="2" class="table table-striped mb30">
							...
							<tr>
								<td><b>DP</b></td>
								<td><input type="text" id="apersen" onKeyUp="HitungTotal();" value="25" style="width:50px;background-color:yellow;" value="25">%</td>
							...
							<tr>
								<td><b>RATE</b></td>
								<td><input type="text" id="arate" onKeyUp="HitungTotal();" style="background-color:yellow;width:50px;" value="11.75">%</td>
								<td></td>
							</tr>
							<tr>
								<td><b>TAHUN</b></td>
								<td><input type="text" id="atahun" onKeyUp="HitungTotal();" style="background-color:yellow;width:50px;" value="3"> Tahun</td>
								<td></td>
							</tr>
							<tr>
								<td><b>BUNGA</b></td>
							...
							<tr>
								<td><b>ASS</b></td>
								<td><input type="text" id="aass" onKeyUp="HitungTotal();" style="background-color:yellow;width:50px;" value="1.32">%</td>
