...
?>
	...
	<div class="mainpanel">
		...
		<div class="pageheader">
			<h2><i class="fa fa-print"></i> Rekapan Group</h2>
			<div class="breadcrumb-wrapper">
				<ol class="breadcrumb">
					<li><a href="<?PHP echo base_url() ?>home">Sentral Group</a></li>
					<li><a href="<?PHP echo base_url() ?>home">Home</a></li>
					<li class="active">Rekapan Group</li>
				</ol>
			</div>
		</div>
		<div class="contentpanel">
		<form action="<?PHP echo base_url(); ?>rekapan_group/cetak_group" method="post" target="_blank">
			<div class="row">
				<div class="col-sm-5">
