...
?>
	...
	<div class="mainpanel">
		...
		<div class="contentpanel">
			<button class="btn btn-primary tambahdata" data-toggle="modal" data-target="#ModalTambah"><i class="fa fa-plus"></i> Tambah Neraca </button>
			<br><br>
				...
				<div class="panel-body">
					<div class="table-responsive">
						<table class="table table-striped mb30" id="table-responsive">
							<thead>
								<tr>
									<th width="15%">Kode Neraca</th>
									<th width="80%">Nama Neraca</th>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<a href="<?PHP echo base_url() ?>neraca/edit/<?PHP echo $row->code; ?>" class="fa fa-pencil" style="text-decoration:none;color:green"></a>
									</td>
								</tr>
								<?PHP
										}
...
<form method="post" action="<?PHP echo site_url(); ?>neraca/tambah_data">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Tambah Neraca</h4>
			</div>
			<div class="modal-body">
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
							<label class="control-label">Kode Neraca <font color="red">*</font></label>
							<input type="text" autocomplete="off" name="code" class="form-control" required />
						</div>
					</div>
					<div class="col-sm-6">
						<div class="form-group">
							<label class="control-label">Nama Neraca <font color="red">*</font></label>
